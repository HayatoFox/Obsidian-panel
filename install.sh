    ...
    const templates = [
        {
            ...
            category: 'minecraft',
            description: 'Serveur Minecraft vanilla officiel',
            ...
            configSchema: JSON.stringify({
                version: { type: 'select', options: ['LATEST', '1.20.4', '1.20.2', '1.19.4', '1.18.2', '1.16.5'], default: 'LATEST' },
        ...
        },
        {
            ...
            category: 'minecraft',
            description: 'Serveur Paper haute performance avec support plugins',
            dockerImage: 'itzg/minecraft-server:latest',
            defaultPort: 25565,
            defaultQueryPort: 25565,
            defaultRconPort: 25575,
            ...
            startupCommand: '',
            configSchema: JSON.stringify({
                version: { type: 'select', options: ['LATEST', '1.20.4', '1.20.2', '1.19.4'], default: 'LATEST' },
                gamemode: { type: 'select', options: ['survival', 'creative', 'adventure', 'spectator'], default: 'survival' },
                maxPlayers: { type: 'number', min: 1, max: 200, default: 50 }
            }),
            envTemplate: JSON.stringify({
                EULA: 'TRUE',
                TYPE: 'PAPER',
        ...
        },
        {
            ...
            category: 'minecraft',
            description: 'Serveur Forge pour mods Minecraft',
            dockerImage: 'itzg/minecraft-server:latest',
            defaultPort: 25565,
            defaultQueryPort: 25565,
            defaultRconPort: 25575,
            ...
            startupCommand: '',
            configSchema: JSON.stringify({
                version: { type: 'select', options: ['1.20.1', '1.19.2', '1.18.2', '1.16.5', '1.12.2'], default: '1.20.1' },
                forgeVersion: { type: 'string', default: 'RECOMMENDED' }
            }),
            envTemplate: JSON.stringify({
                EULA: 'TRUE',
                TYPE: 'FORGE',
        ...
        },
        {
            ...
            category: 'steamcmd',
            description: 'Serveur CS:GO dédié',
            ...
            configSchema: JSON.stringify({
                ...
                gameMode: { type: 'select', options: ['0', '1', '2'], default: '1' },
        ...
        },
        {
            ...
            displayName: 'Valheim',
            category: 'steamcmd',
            description: 'Serveur Valheim dédié',
            ...
            startupCommand: '',
            configSchema: JSON.stringify({
                worldName: { type: 'string', default: 'Obsidian World' },
                serverName: { type: 'string', default: 'Obsidian Valheim' },
                password: { type: 'string', default: '' }
            }),
            envTemplate: JSON.stringify({
                SERVER_NAME: 'Obsidian Valheim',
                WORLD_NAME: 'ObsidianWorld',
                SERVER_PASS: 'secret'
            })
        },
        {
            ...
            displayName: 'Rust',
            category: 'steamcmd',
            description: 'Serveur Rust dédié',
            ...
            envTemplate: JSON.stringify({
                RUST_SERVER_NAME: 'Obsidian Rust',
                RUST_SERVER_MAXPLAYERS: '100',
                RUST_WORLD_SIZE: '3500'
            })
        }
    ];
